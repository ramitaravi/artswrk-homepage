...
const HOW_IT_WORKS = [
  {
    step: "01",
    title: "Create your Dance Teacher Profile",
  ...
  {
    step: "02",
    title: "Find & Connect with Studios",
    desc: "Browse dance studios and open jobs near you - whether for one-time jobs or ongoing work",
...
const JOB_TYPES = [
  { emoji: "📆", label: "Weekly Classes", desc: "Find part-time or full-time roles at studios" },
  { emoji: "💬", label: "Substitute Teaching", desc: "Pick up sub slots at studios near you" },
  { emoji: "⭐️", label: "Guest Classes", desc: "Lead workshops and guest classes" },
  { emoji: "🩰", label: "Private Lessons", desc: "Teach private lessons on your schedule" },
  { emoji: "🏆", label: "Competition Choreography", desc: "Choreograph for competition teams" },
  { emoji: "🎤", label: "Dance Judges", desc: "Judge at competitions and conventions" },
];
    ...
    <div className="bg-white min-h-screen font-[Poppins,sans-serif]">
      ...
      <section className="pt-28 pb-20 px-5 lg:px-10 text-center">
        <div className="max-w-3xl mx-auto">
          <p className="text-sm font-semibold artist-grad-text uppercase tracking-widest mb-4">For Dance Teachers</p>
      ...
      <section className="py-20 px-5 lg:px-10 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-3xl md:text-4xl font-black text-[#111] mb-8">Jobs for Dance Teachers</h2>
      ...
      <section className="py-20 bg-gray-50 px-5 lg:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-[#111] text-center mb-12">Connecting dance teachers &amp; studios nationwide</h2>
      ...
      <section className="py-20 px-5 lg:px-10 max-w-7xl mx-auto">
        ...
        <h2 className="text-3xl md:text-4xl font-black text-[#111] text-center mb-4">Affordable pricing, tailored to dance teachers</h2>
      ...
      <section className="py-20 px-5 lg:px-10">
        <div className="max-w-4xl mx-auto artist-grad-bg rounded-3xl p-12 text-center">
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Ready to find your next dance job?</h2>
          <p className="text-white/80 mb-8">Join thousands of dance teachers already on Artswrk</p>
